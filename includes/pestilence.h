...
# define PAYLOAD_SIZE 0x2a4e - FT_MEMCPY_ADDR + 0x7
# define MAIN_OFFSET 0x29b1 - FT_MEMCPY_ADDR
# define INJECT_SIZE LOADER_SIZE + END_SIZE + SIGN_SIZE + 4

# define OFFSET_1 0x201d - FT_MEMCPY_ADDR
# define OFFSET_2 0x2144 - FT_MEMCPY_ADDR
# define OFFSET_3 0x226e - FT_MEMCPY_ADDR
# define OFFSET_4 0x29bc - FT_MEMCPY_ADDR
